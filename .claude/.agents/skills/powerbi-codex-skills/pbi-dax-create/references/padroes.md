...
1. `% Margem Bruta YoY` (padrão dominante + legibilidade SQLBI — recomendado)
...
Padrões consolidados em 2026-04-26 e alinhados à variante Rebel Analytics em 2026-05-08. Baseado em SQLBI best practices + experiência prática com modelos brasileiros.
